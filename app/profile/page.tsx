            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-800/60 backdrop-blur-sm 
                    ...
                    <div className="relative px-8 pt-12 pb-8">
                        ...
                        <div className="absolute top-6 right-8 animate-pulse opacity-20" style={{ animationDuration: '4s' }}>
                            <Film className="w-5 h-5 text-zinc-500" />
                        </div>
                        <div className="absolute top-10 left-12 animate-pulse opacity-15" style={{ animationDuration: '6s', animationDelay: '2s' }}>
                    ...
                    <div className="px-8 pb-8">
                        <div className="space-y-6">
                            {/* Name field */}
                            <div className="bg-zinc-800/40 border border-zinc-700/30 rounded-xl p-6 
